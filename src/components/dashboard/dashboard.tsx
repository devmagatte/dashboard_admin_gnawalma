								...
								<div className="card-body p-4">
									<div className="media ai-icon">
										...
										<div className="media-body">
											<p className="mb-1">Nombre d&apos;Atéliers</p>
								...
								<div className="widget-stat card">
									<div className="card-body p-4">
										<div className="media ai-icon">
											...
											<div className="media-body">
												<p className="mb-1">Total commande</p>
								...
								<div className="widget-stat card">
									<div className="card-body p-4">
										<div className="media ai-icon">
											...
											<div className="media-body">
												<p className="mb-1">Nombre de transactions</p>
								...
								<div className="card avtivity-card">
									<div className="card-body">
										<div className="media align-items-center">
											...
											<div className="media-body">
												<p className="fs-14 mb-2">Total commande</p>
												<span className="title text-black font-w600">{dashboard?.orders.total} Commandes</span>
											</div>
										</div>
										<div className="progress" style={{height:"5px"}}>
								...
								<div className="card avtivity-card">
									<div className="card-body">
										<div className="media align-items-center">
											...
											<div className="media-body">
												<p className="fs-14 mb-2">Nombre de transactions</p>
												<span className="title text-black font-w600">{dashboard?.transactions.total}</span>
											</div>
										</div>
										<div className="progress" style={{height:"5px"}}>
